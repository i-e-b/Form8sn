	...
	public static Color FromArgb(int alpha, Color baseColor)
			{
				...
				{
					throw new ArgumentException("Arg_ColorComponent", nameof(alpha));
				}
	...
	public static Color FromArgb(int red, int green, int blue)
			{
				if(red < 0 || red > 255)
				{
					throw new ArgumentException
						(("Arg_ColorComponent"), nameof(red));
				}
				if(green < 0 || green > 255)
				{
					throw new ArgumentException
						(("Arg_ColorComponent"), nameof(green));
				}
				if(blue < 0 || blue > 255)
				{
					throw new ArgumentException
						(("Arg_ColorComponent"), nameof(blue));
				}
	...
	public static Color FromArgb(int alpha, int red, int green, int blue)
			{
				...
				{
					throw new ArgumentException
						(("Arg_ColorComponent"), nameof(alpha));
				}
				if(red < 0 || red > 255)
				{
					throw new ArgumentException
